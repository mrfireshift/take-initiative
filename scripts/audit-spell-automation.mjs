...
const CURATED_COMPLETE = Object.freeze({
  ...
  "confusion": "PASS: il workflow area-save multi-target, lo scaling della geometria, gli esiti indipendenti, l'effetto persistente per bersaglio, il TS ricorrente di fine turno e il cleanup di concentrazione sono auditati e approvati sui contratti condivisi.",
  "slow": "PASS: il workflow area-save multi-target, il limite dei bersagli, gli esiti indipendenti, la condizione persistente con le penalità RAW, il TS ricorrente di fine turno e il cleanup di concentrazione sono auditati e approvati sui contratti condivisi.",
